...
class OrderController extends BaseController
{
    ...
    private function orderStorationProcessing($getOrderModel, $cart_id, $getCartModel)
    {
    ...
    public function store()
    {
        ...
        if ($isStoredOrderTable == true) {
            $getCartModel = $this->loadModel('cartModel');
            $orderId = $this->orderStorationProcessing($getOrderModel, $cart_id, $getCartModel);
    ...
    public function orderTracking($userId)
    {
        ...
        $orderList = $orderModel->selectOrderTracking($this->tableOrder, $this->tablePayment);
        $data['newOrderList'] = $orderList;
        $data['sumTotal'] = $orderModel->sumOrderTotalPrice($this->tableOrder, $this->tableDetailOrder, $this->tableCart, $userId[0], $this->tableProduct);
