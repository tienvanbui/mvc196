<div class="footer">
	     ...
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>My account</h4>
						<ul>
							<li><a href="http://localhost:8080/mvc196/login/index">Sign In</a></li>
						...
						<div class="social-icons">
							<h4>Follow Us</h4>
					   		  <ul>
							      ...
							      <li class="googleplus"><a href="https://www.google.com"> </a></li>
							      <li class="contact"><a href="https://www.google.com/intl/vi/gmail/about"> </a></li>
							      <div class="clear"></div>
						     </ul>
   	 					</div>
				</div>
